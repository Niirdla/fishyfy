...
<body>
  <div class="wrap">
		<div class="header_top">
			<div class="logo">
				<a href="index.php"><img src="images/aacaquaticslogo.png" alt="" /></a>
			</div>
...
<?php }else{ ?>
<a class="sign-out" href="?cid=<?php Session::get('cmrId') ?>"><i class='fas fa-sign-out-alt' style='font-size:24px;color:white'></i></a> 
<?php }
?>
